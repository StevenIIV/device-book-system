                    ...
                    <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                        <form class="am-form am-form-horizontal" action="/user/update" method="post">
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="id" name="id" placeholder="编号 / Id" value="${user.id}">
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="department" name="department" placeholder="部门 / department" value="${user.department}">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="authority" class="am-u-sm-3 am-form-label">权限 / authority</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="authority" name="authority" placeholder="权限 / authority" value="${user.authority}">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="job" class="am-u-sm-3 am-form-label">职位 / job</label>
                                <div class="am-u-sm-9">
                                    <input type="text" id="job" name="job" placeholder="职位 / job" value="${user.job}">
                                </div>
                            </div>
                            <div class="am-form-group">
