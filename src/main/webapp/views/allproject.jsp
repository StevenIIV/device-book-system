...
<head>
    ...
    <script type="text/javascript">
        function update(id, name, status, device, description){
            ...
            document.forms[0].action = '<c:url value="/project/projectmodify"/>';
                    ...
                    <div class="am-u-sm-12 am-u-md-6">
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                <a href="/project/projectinsert"><button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</button></a>
                            </div>
                        </div>
                    </div>
                </div>
