                ...
                <div>
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs" >
                            <button type="button" class="am-btn am-btn-default"><a href="/insertdevice"><span class="am-icon-plus"></span> 新增</a></button>
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr v-for="it in list">
                                    ...
                                    <td>{{it.adminid}}</td>
                                    <td>
                                        <div style="float: left"><button class="am-btn am-btn-danger am-btn-xs am-text-secondary"><a v-bind:href="'/changestatus.do?id='+it.id+''">status</a></button></div>
                                        <div style="float: left; margin-left: 5px"><button class="am-btn am-btn-primary am-btn-xs am-hide-sm-only"><a v-bind:href="'/modifydevice?id='+it.id+''">modify</a></button></div>
